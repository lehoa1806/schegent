...
const rustBinding = `// AUTO-GENERATED by scripts/generate-contract-schemas.mjs. Do not edit by hand.\n`
  + `// Run npm run contracts:generate from repo/ to refresh.\n\n`
  + `pub const GENERATED_CONTRACT_SCHEMA_VERSION: u16 = ${GENERATED_SCHEMA_VERSION};\n\n`
  + `${rustArray('SIDEBAR_COMMAND_TYPES', commandTypes)}\n\n`
  + `${rustArray('HOST_MESSAGE_TYPES', hostMessageTypes)}\n\n`
  + `${rustArray('AUDIT_EVENT_TYPES', auditEventTypes)}\n\n`
  + `${rustArray('SETTINGS_KEYS', settings.map((entry) => entry.key))}\n\n`
  + `${rustArray('QUEUE_STATUSES', queueStatuses)}\n\n`
  + `${rustArray('FEATURE_REQUEST_STATUSES', featureRequestStatuses)}\n\n`
  + `${rustArray('WORKFLOW_RUN_STATUSES', workflowRunStatuses)}\n\n`
  + `${rustArray('WAKEUP_SUPPORTED_MODELS', wakeupModels)}\n\n`
  + `pub const RUNNER_DEFAULT_MODEL: &str = ${JSON.stringify(runnerDefaultModel)};\n\n`
  + `#[cfg(test)]\nmod tests {\n    use super::*;\n\n`
...
const generated = new Map([
  ...
  ['contracts/rust/src/lib.rs', rustBinding],

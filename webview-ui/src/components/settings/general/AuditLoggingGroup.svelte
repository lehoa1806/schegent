...
<!--
  FR-R3-143 (T007) — `open` is not a style choice. A collapsed group would put
...
-->
<details class="settings-group" data-testid="settings-group-audit-logging" open>
  <summary>Audit, transcripts, and runtime logging</summary>

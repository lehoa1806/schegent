...
**Source**: Claude / Codex CLI stdout during a phase — the same stream that carries model prose, file contents the model echoed, diffs it produced, and tool output it relayed.

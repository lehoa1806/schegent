...
No operator-visible entries have been recorded in this reconstructed document. Before creating the next `v<version>` tag, replace this sentence with evidence-backed additions, changes, fixes, removals, migration effects, and security notes for that version.

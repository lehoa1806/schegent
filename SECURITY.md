...
- [.specify/memory/constitution.md](.specify/memory/constitution.md) — the project's governing principles, including the append-only-audit and headless-execution non-negotiables that the in-scope surfaces above defend.

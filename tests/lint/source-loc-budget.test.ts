...
const BUDGETS: ReadonlyArray<BudgetEntry> = [
  ...
  // machinery never saw.
  //
  // The file is 846 after six extractions: `sidebar-router-wiring.ts` (240
  ...
  // `evidence-wiring.ts` (91 lines of audit writer and retention). 880 is set
  ...
  { path: 'src/extension.ts', maxLines: 880 },
  //
...
describe('large source file LOC budgets', () => {
  ...
  const LEGACY_FUNCTION_EXEMPTIONS: Readonly<Record<string, number>> = {
    'src/extension.ts:wireStage2': 630
  };
  ...
  it('every legacy exemption only shrinks, and none is stale', () => {
    ...
    const CEILING: Readonly<Record<string, number>> = { 'src/extension.ts:wireStage2': 630 };
